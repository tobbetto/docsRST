...
`1. PRIMER NIVEL DE TITULO 1: Uso de títulos 2 <#primer-nivel-de-titulo-1-uso-de-títulos>`__
...
`4. PRIMER NIVEL DE TÍTULO: Introducción de ejemplos 2 <#primer-nivel-de-título-introducción-de-ejemplos>`__

`5. PRIMER NIVEL DE TÍTULO: Introducción de links a webs externas 3 <#primer-nivel-de-título-introducción-de-links-a-webs-externas>`__

`6. PRIMER NIVEL DE TÍTULO: Introducción de imágenes 3 <#primer-nivel-de-título-introducción-de-imágenes>`__

`7. PRIMER NIVEL DE TÍTULO: Introducción de vídeos 3 <#primer-nivel-de-título-introducción-de-vídeos>`__

`8. PRIMER NIVEL DE TÍTULO: Codificación versiones guías. 3 <#primer-nivel-de-título-codificación-versiones-guías.>`__

`9. PRIMER NIVEL DE TÍTULO: Codificación soportes visuales. 5 <#primer-nivel-de-título-codificación-soportes-visuales.>`__

`10. PRIMER NIVEL DE TÍTULO: Glosario. 7 <#primer-nivel-de-título-glosario.>`__

`11. PRIMER NIVEL DE TÍTULO: Otros recursos. 7 <#primer-nivel-de-título-otros-recursos.>`__
...
Es importante realizar una buena gestión de los :ref:`soportes-visuales`.
